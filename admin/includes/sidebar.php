                ...
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item has-sub">
                        <a href="#" class="nk-menu-link nk-menu-toggle">
                            ...
                            <span class="nk-menu-text">Palz Attributes</span>
                        </a>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a href="html/apps-messages.html" class="nk-menu-link"><span class="nk-menu-text">All</span></a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="html/apps-inbox.html" class="nk-menu-link"><span class="nk-menu-text">Solved</span></a>
                            </li>
                            <li class="nk-menu-item">
                                <a href="html/apps-chats.html" class="nk-menu-link"><span class="nk-menu-text">Unsolved</span></a>
                            </li>
                        </ul><!-- .nk-menu-sub -->
                    </li><!-- .nk-menu-item -->
                </ul><!-- .nk-menu -->
