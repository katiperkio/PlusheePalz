            ...
            ?>
                    ...
                    <div class="nk-tb-item" data-id="<?= $row['id']; ?>">
                        ...
                        <div class="nk-tb-col tb-col-sm">
                            <div class="user-card">
                                <div class="user-avatar user-avatar-sm bg-purple" style="background: url('<?= $row['image_url']; ?>') !important; background-position: center 60% !important; background-repeat: no-repeat !important; background-size: cover !important;">
