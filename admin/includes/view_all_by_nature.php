    ...
    <div class="card-inner">
        <div class="card-title-group">
            <div class="card-title">
                <h6 class="title"><span class="me-2">Traits</span></h6>
            </div>
    ...
    <div class="card-inner p-0 border-top">
        <div class="nk-tb-list nk-tb-orders">
            <div class="nk-tb-item nk-tb-head">
                ...
                <div class="nk-tb-col tb-col-sm"><span>Traits</span></div>
            ...
            $sql = "SELECT 
                        ...
                        GROUP_CONCAT(nature SEPARATOR ', ') AS palz_nature
                    FROM 
                        palz p
                    LEFT JOIN 
                        palz_nature pn 
            ...
            ?>
                    <div class="nk-tb-item">
                        ...
                        <div class="nk-tb-col tb-col-md">
                            <span class="tb-sub"><?= htmlspecialchars($row['palz_nature']); ?></span>
                        </div>
